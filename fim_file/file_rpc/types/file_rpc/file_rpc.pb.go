...
var file_file_rpc_proto_rawDesc = []byte{
	...
	0x1a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x72, 0x70, 0x63, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x49,
...
var file_file_rpc_proto_goTypes = []interface{}{
...
var file_file_rpc_proto_depIdxs = []int32{
	0, // 0: user_rpc.files.FileInfo:input_type -> user_rpc.FileInfoRequest
	1, // 1: user_rpc.files.FileInfo:output_type -> user_rpc.FileInfoResponse
...
func file_file_rpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_file_rpc_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_file_rpc_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
