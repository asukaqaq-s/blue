...
const (
	Groups_IsInGroup_FullMethodName       = "/user_rpc.Groups/IsInGroup"
	Groups_UserGroupSearch_FullMethodName = "/user_rpc.Groups/UserGroupSearch"
)
...
func (c *groupsClient) UserGroupSearch(ctx context.Context, in *UserGroupSearchRequest, opts ...grpc.CallOption) (*UserGroupSearchResponse, error) {
	...
	err := c.cc.Invoke(ctx, Groups_UserGroupSearch_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
